...
Required skills:
<br/>
Explain individual movement techniques.
<br/>
...
player creatediaryrecord ["tier5",["Movement and Discipline","
Movement
<br/>
Movement holds one purpose in combat, to gain positional advantage over the enemy.
When moving under fire, a position with good cover must be chosen as the destination of the movement before movement may begin.
Once a protected position has been chosen, the appropriate technique must be applied to reach the position:
<br/><br/>
Rush
<br/>
Rushing is simply an all out sprint from one cover point to the next protected position. A rush should never last more than five seconds between cover points. Rush only if there is no covered route available.
<br/><br/>
Crawl
<br/>
Crawling is a low and slow movement technique and should be utilized whenever rushing is unsafe.
<br/><br/>
Masking and Flagging
<br/>
Whenever warriors move about the battlespace, situational awareness and movement discipline must be maintained.
More than one of every eight combat casualties are due to friendly fire. Two specific terms are applied to some of the most common and risky safety infractions, called masking and flagging.
<br/>
Masking
<br/>
Whenever one warrior moves in front of another warrior's sector of fire, this safety infraction is called 'masking' friendly fire.
The correct action is to move behind a fire line, never in front of it.
<br/>
Flagging
<br/>
Flagging is whenever a warrior lets the barrel of his weapons aim at any friendly target, intentionally or otherwise.
Correct weapon handling would have all weapons at the low ready until it is time to fire.
"]];

player creatediaryrecord ["tier5",["Fighting Positions","
Offensive Positions
<br/>
...
Support drone operators remotely control unmanned vehicles in support of ground operations.
<br/><br/>
Required Skills:
<br/>
Demonstrate technical knowledge of UV systems.
<br/>
Demonstrate UAV take off, piloting, attack, and landing.
<br/>
